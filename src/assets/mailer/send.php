...
$mail->Password = 'Z4DmEeGFQy2ta0HU';                           // Наш пароль от ящика
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 2525;                                    // TCP port to connect to

$mail->setFrom('bloodfalka@ukr.net', 'Bulka');   // От кого письмо
...
$mail->Subject = 'Данные пользователя ' . $name;
$mail->Body    = '
    <!doctype html>
<html ⚡4email>
...
td .es-button-border-2:hover {
	background:#0A9E91;
	border-color:#076C64 #076C64 #076C64 #076C64;
}
s {
     ...
     <tr> 
      <td valign="top"> 
       <table cellpadding="0" cellspacing="0" class="es-header" align="center"> 
         <tr> 
          <td align="center" bgcolor="#333333" style="background-color: #333333"> 
           <table bgcolor="#333333" class="es-header-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: #333333"> 
             <tr> 
              <td class="es-p20t es-p20b es-p20r es-p20l" align="left"> 
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" width="560" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" style="border-left:3px solid #212522;border-right:3px solid #212522;border-top:3px solid #212522;border-bottom:3px solid #212522;background-position: center bottom" role="presentation"> 
                     <tr> 
                      <td align="center"><p style="font-size: 30px"><span style="background-color:null">Bulka</span></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
       ...
       <table cellpadding="0" cellspacing="0" class="es-content" align="center"> 
         <tr> 
          <td align="center" style="background-image: url(https://obhnrr.stripocdn.email/content/guids/CABINET_3c9be05c2c0e5a9460f90caa88cd9847/images/31151602590581926.jpg);background-repeat: no-repeat;background-position: center top;background-color: #333333" bgcolor="#333333"> 
           <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: transparent"> 
             <tr> 
              <td class="es-p20t es-p20r es-p20l" align="left" style="background-position: center top"> 
             ...
             <tr> 
              <td class="es-p20t es-p10b es-p20r es-p20l" align="left" style="background-color: rgba(159, 182, 136, 0.98)" bgcolor="rgba(159, 182, 136, 0.98)"> 
               <table cellpadding="0" cellspacing="0" class="es-left" align="left"> 
                 <tr> 
                  <td width="270" class="es-m-p20b" align="left"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="left"><p style="line-height: 24px;color: #f4f0f0;font-size: 16px">Имя: ' . $name . '</p></td> 
                     </tr> 
                     <tr> 
                      <td align="left"><p style="line-height: 24px;color: #f4f0f0;font-size: 16px">Телефон: ' . $phone . '</p></td> 
                     </tr> 
                     <tr> 
                      <td align="left"><p style="line-height: 24px;text-decoration: none; color: #f4f0f0;font-size: 16px">E-mail: ' . $email . '</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table> 
               <table cellpadding="0" cellspacing="0" class="es-right" align="right"> 
                 <tr> 
                  <td width="270" align="left"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="left"><p style="line-height: 24px;text-decoration: none; color: #f4f0f0;font-size: 16px">Сообщение: ' . $message . ' &nbsp;</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="600" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="center" class="es-p15t es-p15b" bgcolor="rgba(84, 105, 86, 0.98)" style="backdrop-filter: blur(7px);font-size: 0px;background-color: rgba(84, 105, 86, 0.98)"> 
                       <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" role="presentation"> 
                         <tr> 
                          <td align="center" valign="top" class="es-p10r"><a target="_blank" href="https://viewstripo.email/"><amp-img title="Facebook" src="https://obhnrr.stripocdn.email/content/assets/img/social-icons/logo-gray/facebook-logo-gray.png" alt="Fb" width="32" height="32"></amp-img></a></td> 
                          <td align="center" valign="top"><a target="_blank" href="https://viewstripo.email/"><amp-img title="Instagram" src="https://obhnrr.stripocdn.email/content/assets/img/social-icons/logo-gray/instagram-logo-gray.png" alt="Inst" width="32" height="32"></amp-img></a></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
         ...
         <tr> 
          <td align="center" bgcolor="#333333" style="background-color: #333333"> 
           <table bgcolor="#333333" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: #333333"> 
             <tr> 
              <td class="es-p20t es-p20r es-p20l" align="left" style="background-color: #333333" bgcolor="#333333"> 
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="560" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
